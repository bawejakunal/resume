...
\begin{itemize}
    ...
    \bi
      \item Building infrastructure for realtime news notifications, reminders, recommended notifications etc.
      % \item Integrating recommender systems to serve relevant content for customers via push notifications.
      \item A/B testing product surface and content relevance changes for notifications sent out to customers
      \item Setting up team's technical strategy and project prioritizations
      \item Experiment \& Technical design shepherd for product and infra changes across tech stack
      \item Collaborating with PM, Data Science \& Design on Notifications product strategy for user growth and retention
      % \item Working with design and research on enhancing notifications experience via push copy, landing page optimizations and other presentation improvements.
