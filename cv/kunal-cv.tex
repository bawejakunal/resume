...
\begin{itemize}
    \item \textbf{Coursera.org Course Certificates}\\
    ...
    \item \textbf{Computer Science Elective Courses at Undergraduate Level}\\
    - Cryptography, Data Storage Technologies \& Networks, Artificial Intelligence, Parallel Computing,\\
    \hspace*{0.7em}Data Mining, Information Retrieval.
    
    \item \textbf{Technical Skills}\\
    - C, C++, Verilog, Java, Python, JavaScript, Java Server Pages(JSP), MySQL, HTML5,\\
    \hspace*{0.7em}CSS3, ASP .NET/MVC Framework, Django Framework, Hadoop Framework
\end{itemize}
